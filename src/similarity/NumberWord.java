...
public class NumberWord {
   ...
   private static final String[] numNames = {
    ...
    String soFar;
    //System.out.println("num11 : " +number);
    if (number % 100 < 20){
    ...
    String snumber="";
    if(number >=1000) snumber= convertLessThanOneThousand(number/1000)+ "thousand"+convertLessThanOneThousand(number%1000);
    else snumber= convertLessThanOneThousand(number);
    ...
    temps.setWords(result.replaceAll("^\\s+", "").replaceAll("\\b\\s{2,}\\b", " "));
    // remove extra spaces!
